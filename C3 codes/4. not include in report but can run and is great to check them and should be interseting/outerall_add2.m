...
for i=1:number_sand 
    ...
    sand_pile(1,1:N) = sand_pile(1,1:N) + 2;
    sand_pile(1:N,1) = sand_pile(1:N,1) + 2;
    sand_pile(N,1:N) = sand_pile(N,1:N) + 2;
    sand_pile(1:N,N) = sand_pile(1:N,N) + 2;
