...
N1 = 1;
th1 = 2*pi/(N1*6):2*pi/(N1*nf):2*pi;
n1=length(th1);
r1 = ones(n1,1)';

N2 = 2;
th2 = 2*pi/(N2*6):2*pi/(N2*nf):2*pi;
n2=length(th2);
r2 = 2*ones(n2,1)';

N3=3;
th3 = 2*pi/(N3*6):2*pi/(N3*nf):2*pi;
n3=length(th3);
r3 = 3*ones(n3,1)';

N4=4;
th4 = 2*pi/(N4*6):2*pi/(N4*nf):2*pi;
n4=length(th4);
r4 = 4*ones(n4,1)';

N5=5;
th5 = 2*pi/(N5*6):2*pi/(N5*nf):2*pi;
n5=length(th5);
r5 = 5*ones(n5,1)';

N6=6;
th6 = 2*pi/(N6*6):2*pi/(N6*nf):2*pi;
n6=length(th6);
r6 = 6*ones(n6,1)';

N7=7;
th7 = 2*pi/(N7*6):2*pi/(N7*nf):2*pi;
n7=length(th7);
r7 = 7*ones(n7,1)';

N8=8;
th8 = 2*pi/(N8*6):2*pi/(N8*nf):2*pi;
n8=length(th8);
r8 =8*ones(n8,1)';

N9=9;
th9 = 2*pi/(N9*6):2*pi/(N9*nf):2*pi;
n9=length(th9);
r9 =9*ones(n9,1)';

N10=10;
th10 = 2*pi/(N10*6):2*pi/(N10*nf):2*pi;
n10=length(th10);
r10 =10*ones(n10,1)';

N11=11;
th11 = 2*pi/(N11*6):2*pi/(N11*nf):2*pi;
n11=length(th11);
r11 =11*ones(n11,1)';
