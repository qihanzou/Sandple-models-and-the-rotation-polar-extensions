...
for i=1:number_sand
   ...
   s0 = 20*sand_pile(3,exist_position0);
   polarscatter(ring_0(1,exist_position0),ring_0(2,exist_position0),s0,ring_0(3,exist_position0),'filled',"square");
   hold on
   [exist_position1]=find(ring_1(3,:)>0);
   s1 = 20*sand_pile(3,exist_position1);
   polarscatter(ring_1(1,exist_position1),ring_1(2,exist_position1),s1,ring_1(3,exist_position1),'filled',"square");
   hold on
   [exist_position2]=find(ring_2(3,:)>0);
   s2 = 20*sand_pile(3,exist_position2);
   polarscatter(ring_2(1,exist_position2),ring_2(2,exist_position2),s2,ring_2(3,exist_position2),'filled',"square");
   hold on
   [exist_position3]=find(ring_3(3,:)>0);
   s3 = 20*sand_pile(3,exist_position3);
   polarscatter(ring_3(1,exist_position3),ring_3(2,exist_position3),s1,ring_3(3,exist_position3),'filled',"square");
