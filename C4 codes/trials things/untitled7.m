...
for i=1:number_sand
   ...
   polarscatter(ring_0(1,exist_position0),ring_0(2,exist_position0),'filled',"square");
   colormap(flipud(gray))
   h=colorbar;
   hold on
   [exist_position1]=find(ring_1(3,:)>0);
   polarscatter(ring_1(1,exist_position1),ring_1(2,exist_position1),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position2]=find(ring_2(3,:)>0);
   polarscatter(ring_2(1,exist_position2),ring_2(2,exist_position2),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position3]=find(ring_3(3,:)>0);
   polarscatter(ring_3(1,exist_position3),ring_3(2,exist_position3),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position4]=find(ring_4(3,:)>0);
   polarscatter(ring_4(1,exist_position4),ring_4(2,exist_position4),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position5]=find(ring_5(3,:)>0);
   polarscatter(ring_5(1,exist_position5),ring_5(2,exist_position5),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position6]=find(ring_6(3,:)>0);
   polarscatter(ring_6(1,exist_position6),ring_6(2,exist_position6),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position7]=find(ring_7(3,:)>0);
   polarscatter(ring_7(1,exist_position7),ring_7(2,exist_position7),'filled',"square");
   colormap(flipud(gray))
   hold on
   [exist_position8]=find(ring_8(3,:)>0);
   polarscatter(ring_8(1,exist_position8),ring_8(2,exist_position8),'filled',"square");
   colormap(flipud(gray))
end