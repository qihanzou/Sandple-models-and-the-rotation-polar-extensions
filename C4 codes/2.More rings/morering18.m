        ...
        for j = 1: number_top
            ...
            for q=2:z
                if ismember(I(q),active_position)==1
                    active_or_not2 = rand;
                    %active_or_not3 = rand;
                    if active_or_not2 <= p_st && sand_pile(2,I(q)) > radius_top_now && sand_pile(1,I(q)) > theta_top_now
                    ...
                    if active_or_not2 <= p_st_c && sand_pile(2,I(q)) < radius_top_now && sand_pile(1,I(q)) < theta_top_now
                       sand_pile(3,I(q)) = sand_pile(3,I(q)) + add_number_induce;
