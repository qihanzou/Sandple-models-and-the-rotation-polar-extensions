...
regeneration_time_2 = 51; % topping regerneration time
shorest_number = 7;
add_number=2;
add_number_induce=1;
        ...
        for j = 1: number_top
            ...
            for q=2:z
                if ismember(I(q),active_position)==1
                    ...
                    active_or_not3 = rand;
                    active_or_not4 = rand;
                    if active_or_not2 <= p_st1 && sand_pile(2,I(q)) ~= radius_top_now && sand_pile(1,I(q))<theta1
                    ...
                    elseif active_or_not3 <= p_st2 && sand_pile(2,I(q)) == radius_top_now
                       sand_pile(3,I(q)) = sand_pile(3,I(q)) + add_number_induce;
                       active_matrix(3,I(q)) = active_matrix(3,I(q)) + regeneration_time_2 + 1;
                       life_time(3,I(q)) = life_time(3,I(q)) + lifetime2;
                    elseif active_or_not2 <= p_st3 && sand_pile(2,I(q)) ~= radius_top_now && sand_pile(1,I(q))>theta1
                       sand_pile(3,I(q)) = sand_pile(3,I(q)) + add_number_induce;
                       active_matrix(3,I(q)) = active_matrix(3,I(q)) + regeneration_time_2;
                       life_time(3,I(q)) = life_time(3,I(q)) + lifetime2;
                    end
...
s1 = 10*history(3,exist_position1);
