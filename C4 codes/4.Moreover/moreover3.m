...
for i=1:number_sand
    ...
    sand_pile_zero=[sand_pile_zero{:}];
    [exist_position_zero]=find(sand_pile_zero(5,:) > 0);
    ...
    [exist_position_one]=find(sand_pile_one(5,:) > 0);
    polarscatter(sand_pile_one(1,exist_position_zero),sand_pile_one(2,exist_position_zero),"o","filled");
    hold on
    polarscatter(sand_pile_one(1,exist_position_one),sand_pile_one(2,exist_position_one),"x","filled");
    hold off
