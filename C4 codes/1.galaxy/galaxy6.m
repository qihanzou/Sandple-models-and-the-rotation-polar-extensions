...
regeneration_time_1 = 0; % dropping regerneration time
regeneration_time_2 = 1; % topping regerneration time
shorest_number = 5;
add_number=3;
...
for i=1:number_sand
    ...
    isInside_1 = discretize(theta_now_degree, [65,85])==1;
    %isInside_1 = discretize(theta_now_degree, [30,60])==1;
    %isInside_2 = discretize(theta_now_degree, [90,120])==1;
    isInside_2 = discretize(theta_now_degree, [155,175])==1;
    %isInside_3 = discretize(theta_now_degree, [150,180])==1;
    %isInside_4 = discretize(theta_now_degree, [210,240])==1;
    isInside_3 = discretize(theta_now_degree, [245,265])==1;
    %isInside_5 = discretize(theta_now_degree, [270,300])==1;
    %isInside_6 = discretize(theta_now_degree, [330,360])==1;
    isInside_4 = discretize(theta_now_degree, [335,355])==1;
    %{
    if radius_1 == 1
